...
class _LiveTrackingScreenState extends State<LiveTrackingScreen> {
  ...
  // الموقع الافتراضي للمستخدم الحالي (دمام)
  ...
  // ─── فتح Google Maps بشكل صحيح ومضمون ───────────────────────────────────────
  ...
  Future<void> _openGoogleMaps(double destLat, double destLng) async {
    ...
    // استخدام الرابط الرسمي لتوجيهات خرائط جوجل
    final String url = userLat != null
  ...
  void _selectBus(String busNumber) {
    ...
    if (loc != null && _selectedBusNumber != null) {
      ...
      // تم إلغاء فتح الخرائط هنا لكي لا ينزعج المستخدم بالخروج التلقائي من التطبيق
    }
  }
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          // زر فتح خرائط جوجل الخارجي (يظهر فقط إذا كانت بيانات الموقع متوفرة)
          if (loc != null)
            IconButton(
              icon: const Icon(
                Icons.map_rounded,
              ...
              onPressed: () => _openGoogleMaps(loc.lat, loc.lng),
            ),
        ],
      ),
    );
