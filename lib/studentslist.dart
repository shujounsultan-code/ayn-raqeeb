...
class _GradesScreenState extends State<GradesScreen> {
  ...
  // ملاحظة: إذا كنتِ تستخدمين محاكي أندرويد، استبدلي localhost بـ 10.0.2.2
  final String baseUrl = 'http://10.0.2.2/graduation-project-2-main4/graduation-project-2-main';
        ...
        children: [
          Padding(
            ...
            child: Row(
              ...
              children: [
                const Text('قائمة الصفوف', 
                  style: TextStyle(color: Color(0xFF6B7280), fontWeight: FontWeight.w600)),
                ElevatedButton(
                  onPressed: () {}, // إضافة منطق الإضافة هنا لاحقاً
          ...
          children: [
            ...
            Expanded(
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text('الصف $name الابتدائي', 
                    style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 15)),
                  const Text('عرض الطالبات', 
...
class StudentsListScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('طالبات الصف $gradeName', 
        ...
        builder: (context, snapshot) {
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            return Center(child: Padding(
              ...
              child: Text('عذرًا: ${snapshot.error}', textAlign: TextAlign.center),
            ));
          } else if (!snapshot.hasData || snapshot.data!.isEmpty) {
            return const Center(child: Text('لا توجد طالبات في هذا الصف حالياً.'));
          }
            ...
            itemBuilder: (context, index) {
              ...
              return Container(
                ...
                child: ListTile(
                  ...
                  subtitle: Text('باص رقم ${student.bus}', 
                    style: const TextStyle(color: Color(0xFF1B7C80), fontSize: 13)),
                ),
              );
            },
          );
